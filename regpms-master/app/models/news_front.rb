class NewsFront < ActiveRecord::Base
  
  scope :front_published, -> { limit(36).order("published_at DESC").where(["workflow_state = ?", "published"]) }
  ...
  # has_attached_file :image, styles: { xlarge: "1920x1080>", large: "1024x1024>", medium: "500x500>", small: "300x300>", xsmall: "150x150>", thumb: "100x100>", front: "100x100#", avatar: "36x36#", row: "26x26#" },
                    # convert_options: {
  ...
  validates_attachment_content_type :image, not: /\A*\/.exe\Z/
