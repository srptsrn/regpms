class BaseSalary < ActiveRecord::Base
  
  belongs_to :workflow_state_updater, class_name: "User"
  belongs_to :evaluation
  belongs_to :position_level
  
  validates :position_level_id, presence: true, uniqueness: {scope: [:evaluation_id]}
  validates :min_low, presence: true
  validates :max_low, presence: true
  validates :base_low, presence: true
  validates :min_high, presence: true
  validates :max_high, presence: true
  validates :base_high, presence: true
