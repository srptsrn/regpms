class Faculty < ActiveRecord::Base
  ...
  belongs_to :dean, class_name: "User"
  belongs_to :leader, class_name: "User"
  
  has_many :faculty_users, -> { order("users.firstname, users.lastname").includes(:user) }
  accepts_nested_attributes_for :faculty_users, :reject_if => :all_blank, :allow_destroy => true
  
  validates :name, presence: true, uniqueness: true
  # validates :dean_id, presence: true
