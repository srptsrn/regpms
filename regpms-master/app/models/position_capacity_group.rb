class PositionCapacityGroup < ActiveRecord::Base
  ...
  has_many :position_capacities, -> { order(:sorting) }
  accepts_nested_attributes_for :position_capacities, :reject_if => :all_blank, :allow_destroy => true
