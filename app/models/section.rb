class Section < ActiveRecord::Base
  ...
  belongs_to :vice_leader, class_name: "User"
  
  has_many :section_users, -> { order("users.firstname, users.lastname").includes(:user) }
  accepts_nested_attributes_for :section_users, :reject_if => :all_blank, :allow_destroy => true
  
  validates :name, presence: true, uniqueness: true
  # validates :leader_id, presence: true
  # validates :vice_leader_id, presence: true
