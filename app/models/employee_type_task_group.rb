class EmployeeTypeTaskGroup < ActiveRecord::Base
  ...
  has_many :employee_type_tasks, -> { order(:sorting) }
  accepts_nested_attributes_for :employee_type_tasks, :reject_if => :all_blank, :allow_destroy => true
